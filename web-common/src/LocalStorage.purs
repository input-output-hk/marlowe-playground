...
toEvent
  :: Nullable String -> Nullable String -> Nullable String -> RawStorageEvent
...
foreign import _listen
  :: EffectFn2
       ( Fn3 (Nullable String) (Nullable String) (Nullable String)
           RawStorageEvent
       )
...
listen =
  producer
    $ makeAff \callback -> do
        canceller <- runEffectFn2 _listen (mkFn3 toEvent)
          (callback <<< Right <<< Left)

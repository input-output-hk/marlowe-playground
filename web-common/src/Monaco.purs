...
newtype LanguageExtensionPoint = LanguageExtensionPoint { id :: String }

_id :: Lens' LanguageExtensionPoint String
_id = _Newtype <<< prop (Proxy :: _ "id")

derive instance newtypeLanguageExtensionPoint ::
  Newtype LanguageExtensionPoint _

derive instance genericLanguageExtensionPoint ::
  Generic LanguageExtensionPoint _

derive newtype instance encodeJsonLanguageExtensionPoint ::
  EncodeJson LanguageExtensionPoint

newtype MonarchLanguageBracket = MonarchLanguageBracket
  { close :: String, open :: String, token :: String }

derive instance newtypeMonarchLanguageBracket ::
  Newtype MonarchLanguageBracket _

derive instance genericMonarchLanguageBracket ::
  Generic MonarchLanguageBracket _

derive newtype instance encodeMonarchLanguageBracket ::
  EncodeJson MonarchLanguageBracket
...
newtype LanguageRule = LanguageRule { regex :: Regex, action :: Action }

derive instance newtypeLanguageRule :: Newtype LanguageRule _

derive instance genericLanguageRule :: Generic LanguageRule _

instance encodeLanguageRule :: EncodeJson LanguageRule where
  encodeJson (LanguageRule r) = encodeJson
    { regex: unsafeCoerce r.regex :: Json, action: r.action }

simpleRule :: Regex -> String -> LanguageRule
simpleRule regex token = LanguageRule
  { regex, action: Action { token, next: Nothing, log: Nothing } }

simpleRuleWithLog :: Regex -> String -> String -> LanguageRule
simpleRuleWithLog regex token msg = LanguageRule
  { regex, action: Action { token, next: Nothing, log: Just msg } }

simpleRuleWithAction :: Regex -> String -> String -> LanguageRule
simpleRuleWithAction regex token next = LanguageRule
  { regex, action: Action { token, next: Just next, log: Nothing } }

simpleRuleCases :: Regex -> Array (Tuple String String) -> LanguageRule
simpleRuleCases regex cases = LanguageRule
  { regex, action: Cases { log: Nothing, cases: (Object.fromFoldable cases) } }

simpleRuleCasesWithLog
  :: Regex -> String -> Array (Tuple String String) -> LanguageRule
simpleRuleCasesWithLog regex msg cases = LanguageRule
  { regex, action: Cases { log: Just msg, cases: (Object.fromFoldable cases) } }
...
foreign import completionItemKindEq_
  :: Fn2 CompletionItemKind
       CompletionItemKind
       Boolean
...
foreign import completionItemKindOrd_
  :: Fn5 Ordering Ordering Ordering
       CompletionItemKind
       CompletionItemKind
       Ordering
...
instance encodeMarkerSeverity :: EncodeJson MarkerSeverity where
  encodeJson = unsafeCoerce

instance decodeJsonMarkerSeverity :: DecodeJson MarkerSeverity where
...
instance encodeUri :: EncodeJson Uri where
  encodeJson = unsafeCoerce
...
type IMarkerData = Record (Marker ())

getRange :: IMarkerData -> IRange
getRange { startLineNumber, startColumn, endLineNumber, endColumn } =
  { startLineNumber, startColumn, endLineNumber, endColumn }

type IMarker = Record (Marker (owner :: String, resource :: Uri))
...
type Theme = { name :: String, themeData :: IStandaloneThemeData }
...
foreign import onDidChangeContent_
  :: forall a. EffectFn2 Editor ({} -> Effect a) Unit

foreign import registerLanguage_ :: EffectFn2 Monaco Json Unit

foreign import defineTheme_ :: EffectFn2 Monaco Theme Unit

foreign import setMonarchTokensProvider_
  :: EffectFn3 Monaco String
       MonarchLanguage
       IDisposable

foreign import setModelMarkers_
  :: EffectFn4 Monaco ITextModel String
       (Array IMarkerData)
       Unit
...
foreign import getDecorationRange_
  :: EffectFn2 ITextModel String
       (Nullable IRange)

foreign import setStrictNullChecks_ :: EffectFn2 Monaco Boolean Unit

foreign import setDeltaDecorations_
  :: EffectFn3 Editor (Array String)
       (Array IModelDeltaDecoration)
       (Array String)
...
foreign import setTokensProvider_
  :: EffectFn3 Monaco String TokensProvider
       IDisposable
...
foreign import registerHoverProvider_
  :: EffectFn3 Monaco String HoverProvider
       IDisposable

foreign import registerCompletionItemProvider_
  :: EffectFn3 Monaco String
       CompletionItemProvider
       IDisposable

foreign import registerCodeActionProvider_
  :: EffectFn3 Monaco String
       CodeActionProvider
       IDisposable

foreign import registerDocumentFormattingEditProvider_
  :: EffectFn3 Monaco
       String
...
registerLanguage monaco = runEffectFn2 registerLanguage_ monaco <<< encodeJson

defineTheme :: Monaco -> Theme -> Effect Unit
defineTheme = runEffectFn2 defineTheme_

setMonarchTokensProvider
  :: Monaco -> String -> MonarchLanguage -> Effect IDisposable
...
getDecorationRange model id = toMaybe <$> runEffectFn2 getDecorationRange_ model
  id
...
setModelMarkers
  :: Monaco -> ITextModel -> String -> Array IMarkerData -> Effect Unit
...
registerCompletionItemProvider
  :: Monaco -> String -> CompletionItemProvider -> Effect IDisposable
registerCompletionItemProvider = runEffectFn3 registerCompletionItemProvider_

registerCodeActionProvider
  :: Monaco -> String -> CodeActionProvider -> Effect IDisposable
registerCodeActionProvider = runEffectFn3 registerCodeActionProvider_

registerDocumentFormattingEditProvider
  :: Monaco -> String -> DocumentFormattingEditProvider -> Effect IDisposable
registerDocumentFormattingEditProvider = runEffectFn3
  registerDocumentFormattingEditProvider_

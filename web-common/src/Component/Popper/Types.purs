...
pTop :: Number -> Padding
pTop top = Padding
  { top: Just top, left: Nothing, right: Nothing, bottom: Nothing }

pLeft :: Number -> Padding
pLeft left = Padding
  { top: Nothing, left: Just left, right: Nothing, bottom: Nothing }

pRight :: Number -> Padding
pRight right = Padding
  { top: Nothing, left: Nothing, right: Just right, bottom: Nothing }

pBottom :: Number -> Padding
pBottom bottom = Padding
  { top: Nothing, left: Nothing, right: Nothing, bottom: Just bottom }

type CalculateFromBoundingBox a =
  { popper :: Rect, reference :: Rect, placement :: Placement } -> a

type Offset = { skidding :: Number, distance :: Number }

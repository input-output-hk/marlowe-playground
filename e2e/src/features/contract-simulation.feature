...
@wip
    Scenario: As a user who is simulating a contract, I would like to see a transaction log
      ...
      And the "heading" with 'deposit transaction - (Role "Buyer")' text should contain "Buyer deposited ₳ 100 from his/her wallet into Seller account" text
      And the 'heading' with 'choice transaction - Everything is alright' text should contain 'Buyer chose the value 0 for choice with id "Everything is alright"' text
      ...
      Then the "heading" with 'deposit transaction - (Role "Buyer")' text should contain "Buyer deposited ₳ 100 from his/her wallet into Seller account" text
      And the 'heading' with 'choice transaction - Report problem' text should contain 'Buyer chose the value 1 for choice with id "Report problem"' text
      ...
      Then the 'heading' with 'choice transaction - Confirm problem' text should contain 'Seller chose the value 1 for choice with id "Confirm problem"' text
      ...
      And the 'heading' with 'choice transaction - Dispute problem' text should contain 'Seller chose the value 0 for choice with id "Dispute problem"' text
      And I should see a "button" with "Confirm problem" text
      And I should see a "button" with "Dismiss claim" text

      When I click the "button" with "Confirm problem" text
      Then the 'heading' with 'choice transaction - Confirm problem' text should contain 'Mediator chose the value 1 for choice with id "Confirm problem"' text
      And the "heading" with 'payment transaction - (Party (Role "Buyer"))' text should contain "The contract pays ₳ 100 from account of Buyer to Buyer wallet" text
      And I should see a "heading" with "Contract ended" text

      When I click the "button" with "Undo" text
      And I click the "button" with "Dismiss claim" text
      Then the 'heading' with 'choice transaction - Dismiss claim' text should contain 'Mediator chose the value 0 for choice with id "Dismiss claim"' text

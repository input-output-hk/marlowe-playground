...
const mkAddressBasedEscrow = (buyerAddress, sellerAddress, mediatorAddress) => {
...
When(/^I generate Escrow contract with "([^"]*)" as a buyer and "([^"]*)" as a seller and "([^"]*)" as a mediator and call it "([^"]*)"$/, async function (buyer, seller, mediator, contractNickname) {

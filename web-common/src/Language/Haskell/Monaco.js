  ...
  return {
    ...
    tokenizer: {
      ...
      class_: [
        ...
        ["\\b[a-z][a-zA-Z0-9_']*\\b", "variable.other.generic-type.haskell"],
        // default token
        [".", "keyword"],
      ],
      instance: [
      ...
      deriving: [
        ...
        ["\\b[A-Z][a-zA-Z_']*", "entity.other.inherited-class.haskell"],
      ],
      block_comment: [
        ["\\{-(?!#)", "comment", "@push"],
        ["-\\}", "comment", "@pop"],
      ...
      module_name: [["[A-Z][A-Za-z._']*", "support.other.module.haskell"]],
      function_: [
